...
export default function VehicleCard({ vehicle, vipLevel = "NONE" }: VehicleCardProps) {
  ...
  return (
    ...
    >
      <div className={`aspect-video bg-gradient-to-br ${categoryGradients[vehicle.category]} flex items-center justify-center relative`}>
        ...
        <p className="text-muted-foreground text-sm">Imagen próximamente</p>
      </div>
